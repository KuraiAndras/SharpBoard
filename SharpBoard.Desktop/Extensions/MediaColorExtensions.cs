...
namespace SharpBoard.Desktop.Extensions
{
    public static class MediaColorExtensions
    {
        ...
        {
            var selectedColor = color ?? new Color { R = 255, G = 255, B = 255, A = 255 };

            var (nR, nG, nB, nA) = (selectedColor.R / 255f, selectedColor.G / 255f, selectedColor.B / 255f, selectedColor.A / 255f);
